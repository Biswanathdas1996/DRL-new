...
response = client.models.generate_content(
    ...
    contents=f"""
        analyse {data}, find proper combination to generate @nivo/sankey line chart 
""",
    config={
        'response_mime_type': 'application/json',
        'response_schema': list[SankeyChartData],
    },
)
...
my_recipes: list[SankeyChartData] = response.parsed