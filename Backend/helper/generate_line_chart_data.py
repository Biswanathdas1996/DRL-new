...
class DataItem(BaseModel):
    x: str  # Replace with the actual expected fields for the data items
    y: float  # Replace with the actual expected fields for the data items
...
response = client.models.generate_content(
    ...
    contents=f"""
        analyse {data}, find proper combination to generate @nivo/line line chart 
""",
    config={
